AFRAME.registerComponent("coins", {
    init: function(){
        for(var i = 1;i<=10;i++){
            ...
            const posX = Math.random() * 10 + -10;
            const posY = Math.random() * 5 + -1;
            const posZ = Math.random() * 30 + -20;
    ...
    createCoins: function(id,position){
        const treasureEntity = document.querySelector("#coinsId");
        ...
        coinEl.setAttribute("static-body",{shape:"sphere", radius:2})
